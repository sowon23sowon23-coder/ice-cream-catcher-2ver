...
export default function LoginScreen({
  ...
  return (
    <main className="relative min-h-[844px] overflow-hidden bg-[radial-gradient(circle_at_12%_8%,#ffffff_0%,#ffedf7_36%,#f9d3e7_100%)] p-5">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(844px-2.5rem)] max-w-sm items-center">
